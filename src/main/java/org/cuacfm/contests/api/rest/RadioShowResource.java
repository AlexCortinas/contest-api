...
public class RadioShowResource {
	...
	@ApiOperation(value = "List all shows of the contest")
	...
	@ApiOperation(value = "Get a show by the code")
	...
	@ApiOperation(value = "Create a show. The only needed parameter is the name.")
	...
	@ApiOperation(value = "Delete a show by the code")
